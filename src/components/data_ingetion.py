...
class DataIngestion:
    ...
    def initiate_data_ingestion(self) -> Path:
         ...
         try:
             featue_store_file_path = self.export_data_into_feature_store_file_path()

             logging.info("got the data from mongodb")

             logging.info("
                          exited initiate_data_ingestion methoda of data ingestion class")

             return featue_store_file_path
